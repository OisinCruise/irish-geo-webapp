...
|-------|------------|---------|
| **Database** | PostgreSQL 17 + PostGIS 3.6 | Spatial data storage and queries |
...
| **Database Hosting** | Neon.tech | Managed PostgreSQL with PostGIS |
...
4. **Database:** Neon.tech PostgreSQL + PostGIS
...
DB_HOST=ep-silent-breeze-a8a70nhq-pooler.eastus2.azure.neon.tech
DB_PORT=5432
```
...
- Managed PostgreSQL 17 with PostGIS 3.6
